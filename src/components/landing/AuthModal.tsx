        ...
        <div className="p-6 sm:p-8 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-9 pr-9 py-2 rounded-xl border border-slate-300 text-slate-900 text-xs sm:text-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-950 focus:border-transparent transition"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-2.5 px-4 rounded-xl bg-slate-950 hover:bg-slate-800 text-white font-semibold text-xs sm:text-sm transition shadow-md hover:shadow-lg active:scale-[0.99] flex items-center justify-center gap-2 disabled:opacity-70 cursor-pointer mt-1"
            >
              {isLoading ? (
                <>
          ...
          <div className="text-center pt-2 border-t border-slate-100">
            <button
              ...
              className="text-xs font-medium text-slate-500 hover:text-slate-900 transition inline-flex items-center gap-1 group"
            >
              <span>Skip login and continue as guest</span>
