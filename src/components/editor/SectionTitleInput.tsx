    ...
    <div className="bg-slate-50/80 border border-slate-200/80 rounded-xl p-3.5 mb-4 space-y-2.5">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-8 pr-3 py-1.5 text-xs font-semibold text-slate-900 bg-white border border-slate-300 rounded-lg focus:outline-none focus:border-slate-900 focus:ring-1 focus:ring-slate-900 transition-all placeholder:text-slate-400 placeholder:font-normal shadow-2xs"
        />
      </div>
